...
const CapitalPools = () => {
  ...
  const handleStakeSuccess = (amount, pool) => {
    ...
    toast({
      ...
      description: `You've successfully staked ${amount} $SHIELD in the ${pool.name} pool.`,
      variant: "default",
    });
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Stake your $SHIELD tokens in our insurance pools to earn consistent yields while providing
                ...
                <div className="bg-gradient-to-r from-safetyblue-50 to-safetyblue-100 rounded-lg p-4">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-2xl font-bold">{userPortfolio.totalStaked} $SHIELD</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-teal-50 to-teal-100 rounded-lg p-4">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-2xl font-bold">{userPortfolio.estimatedYield} $SHIELD</p>
                    </div>
                  </div>
                </div>
