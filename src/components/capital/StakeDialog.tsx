    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Stake your $SHIELD tokens to earn yields while providing capital for insurance products.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6 py-4">
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-sm text-gray-500">
              <span>{pool.minStake} $SHIELD</span>
              <span>{maxAmount} $SHIELD</span>
            </div>
          </div>
          ...
          <div className="space-y-2 bg-gray-50 p-4 rounded-md">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-medium text-teal-600">{expectedYield} $SHIELD</span>
            </div>
            <div className="flex justify-between">
