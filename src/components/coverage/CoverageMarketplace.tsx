      ...
      <CardContent className="p-6">
        ...
        <div className="flex justify-between items-center py-2 border-t border-b border-gray-100 my-4">
          <div>
            ...
            <p className="font-semibold">{coverage.premium} $SHIELD</p>
          </div>
          <div>
            <p className="text-sm text-gray-500">Coverage</p>
            <p className="font-semibold">{coverage.coverage} $SHIELD</p>
          </div>
          <div>
          ...
          <DialogContent>
            ...
            <div className="py-4 space-y-4">
              ...
              <div className="flex justify-between items-center py-2 border-b">
                ...
                <span className="font-medium">{coverage.premium} $SHIELD</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b">
                <span className="text-gray-600">Coverage Amount</span>
                <span className="font-medium">{coverage.coverage} $SHIELD</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b">
