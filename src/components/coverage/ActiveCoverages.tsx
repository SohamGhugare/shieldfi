            ...
            <TableBody>
              {ACTIVE_COVERAGES.map((coverage) => (
                <TableRow key={coverage.id}>
                  ...
                  <TableCell>{coverage.premium} $SHIELD</TableCell>
                  <TableCell>{coverage.coverage} $SHIELD</TableCell>
                  <TableCell>
      ...
      <Card className="border-0 shadow-md">
        <CardContent className="p-6">
          <div className="text-center">
            ...
            <p className="text-3xl font-bold text-safetyblue-500">19,000 $SHIELD</p>
